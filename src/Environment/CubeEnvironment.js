...
import MATE from '../Assets/Models/pedro_car.glb'
...
class CubeEnvironment extends Component {
    ...
    constructor(props) {
		...
		this.overlayItem = new OverlayItem(
			"A Day's Time", 
			"VIDEO", 
			"https://www.youtube.com/embed/gVKEsegAGmQ"
		)
      }
	...
	populateScene = () => {
		...
		this.addModel(MATE, new THREE.Vector3(0,0,0), this.overlayItem);
		this.setupFog();
	};
	...
	setupCamera = () => {
		...
		this.camera.position.z =0.5; // is used here to set some distance from a cube that is located at z = 0
	};
	 ...
	 */
	setupFog = () => {
		this.scene.fog = new THREE.FogExp2(new THREE.Color('white'), 1); // Color, Density
	};
